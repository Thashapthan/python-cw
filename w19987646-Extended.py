...
progress = {} # dictionary to store the progressions of students with student id as key
...
while True:  #to repeatly asking the credits if the user selects "y"  
    while True: #to repeatly asking the credits while the input credits are not valid
        studentID = input("\nPlease enter your student ID no: ") #asking user input and store the student id in a variable
        while studentID in progress.keys(): #checks whether the student id is already exist or not
            print('Student ID already exist.\nPlease Try Again\n') #error message if the student id is already exist
            studentID = input('Please enter your student ID no: ')
    ...
    progress[studentID] = [status, passCredit, deferCredit, failCredit] #append the enterd credits and progression outcome to a dictionary as a value of entered student ID
...
print("\n")
print("Part 4:")
# to print the student details which are stored in a dictionary
